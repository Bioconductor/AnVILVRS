...
AnVILVRS::install_AnVILVRS(envname = "vrs_env")
...
To calculate the Cohort Allele Frequency (CAF) using the 1000 Genomes Project
based on a VRS Allele ID, use the `get_caf` function. You will need a `.gz`
zipped VCF file containing 1000 Genomes Project variants with allele frequency
annotations and its corresponding index file.
